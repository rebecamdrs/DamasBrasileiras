...
MUSICA_NORMAL = pygame.mixer.Sound('assets/sounds/loop-normal.mp3')
...
VAI = pygame.mixer.Sound('assets/sounds/go.mp3') 
...
MODO_JOGO = pygame.transform.scale(pygame.image.load('assets/images/modo_jogo.png'), (308.12, 144.55))
...
BG_MODO_JOGO = pygame.image.load('assets/images/bg_modo_jogo.png')